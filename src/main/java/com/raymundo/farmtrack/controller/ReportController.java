 ...
 * @author RaymundoZ
 */
@Tag(name = "ReportController", description = "Controller class that handles report-related operations")
@RestController
...
public class ReportController {
     ...
     */
    @Operation(summary = "Endpoint for creating a report")
    @PostMapping
     ...
     */
    @Operation(summary = "Endpoint for retrieving general statistics")
     ...
     */
    @Operation(summary = "Endpoint for retrieving general statistics by user")
    ...
    public ResponseEntity<SuccessDto<StatisticsDto>> getGeneralStatistics(@Valid @RequestBody StatisticsDto statisticsDto,
                                                                          @PathVariable
                                                                          @Parameter(description = "The email address of the user for whom general statistics are to be retrieved")
                                                                          String userEmail) {
        return ResponseEntity.ok(new SuccessDto<>(
                HttpStatus.OK.value(),
